                  ...
                  <div class="box">
                    <div class="div" style="padding:20px;">
                      ...
                      <div class="box-header">
                          <h3 class="box-title">Data Table of Subject</h3>
                      </div><!-- /.box-header -->
                                ...
                                @foreach ($subject as $s)
                                  <tr>
                                      ...
                                      <td>
                                        ...
                                        <a href="{!! route('admin.subject.edit',$s->id) !!}" class="btn btn-success">Edit</a>
                                            ...
                                            <div class="modal-dialog" role="document">
                                              <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                  <form action="{!! route('admin.subject.delete', $s->id) !!}"  method="post">
                                                    {{ csrf_field() }}
