            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">
                            Data Table of Assingment Request
                        </h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body table-responsive">
                        <table class="table table-bordered table-striped" id="myTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <a href="{!! route('admin.student.view',$a->student->id) !!}">
                                            {{$a->student->name}}
                                        </a>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <a class="btn btn-warning" href="{!! route('admin.assingment.view',$a->assingment->id) !!}">
                                            View
                                        </a> 
                                        <a class="btn btn-success" href="{!! route('admin.assingment.edit',$a->assingment->id) !!}">
                                            Edit
                                        </a>
                                    </td>
                                    {{--
