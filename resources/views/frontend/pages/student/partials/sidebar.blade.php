...
<div class="col-md-3">
 ...
 <a class="{{Route::is('student.order.complete')? 'active' : ''}}" href="{!! route('student.order.complete') !!}">Complete <span class="badge badge-primary badge-pill"><b>{{App\Models\CompleteAssingment::newStdComOrder(Auth::id())}}</b></span></a>
