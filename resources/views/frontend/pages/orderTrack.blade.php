                    ...
                    <div class="row align-items-center">
                      <div class="col-12">
                        <div class="row justify-content-center align-items-center text-center">
                          <div class="col-lg-6">
                            <h1 data-aos="fade-up" data-aos-delay="0">Order Track {{$order->order_trace_id}}</h1>
                            <p data-aos="fade-up" data-aos-delay="100">{{$order->assingment->created_at}} / 12 Week &bullet; 2,193 students &bullet; <a href="#" class="text-white">6 comments</a></p>
                          </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="col-lg-12 ml-auto" data-aos="fade-up" data-aos-delay="500">
                        <div class="row">
                          <h1>{{$order->assingment->assingment_name}}</h1>
