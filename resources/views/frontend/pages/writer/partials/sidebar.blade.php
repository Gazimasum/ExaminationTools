...
<a class="{{Route::is('writer.profile')? 'active' : ''}}" href="{!! route('writer.profile') !!}">Profile</a>
    ...
    <a class="{{Route::is('writer.message.view')? 'active' : ''}}" href="{!! route('writer.message.view') !!}">Message <span class="badge badge-primary badge-pill"><b id="noti_number_sidebar"></b></span></a>
