                ...
                <div class="container" style="margin-top:20px">
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <tbody>
                        <tr>
                          <th> Name : {{$assingment->order->assingment->assingment_name}}</th>
                        </tr>
                          <tr><th> Type Name: {{$assingment->order->assingment->type->name}}</th></tr>
                          <tr><th> Subject Name : {{$assingment->order->assingment->subject->name}}</th></tr>
                          <tr><th> Education Level : {{$assingment->order->assingment->education_level->name}}</th></tr>
                          <tr><th> Deadline Date : {{$assingment->order->assingment->deadline_date}}</th></tr>
                        </tr>
